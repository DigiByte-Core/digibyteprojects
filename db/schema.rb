...
ActiveRecord::Schema.define(version: 20180121184454) do
  ...
  add_index "record_changes", ["record_type", "record_id"], name: "index_record_changes_on_record_type_and_record_id"
  ...
  add_index "tips", ["reason_type", "reason_id"], name: "index_tips_on_reason_type_and_reason_id"
